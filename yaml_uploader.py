...
if __name__ == "__main__":
    # 上传 profile
    #ai_id = upload_yaml("D:\\profiles\\景柚\\profile.yaml", "AIs")

    # 上传对应的 scene
   upload_yaml("D:\\profiles\\stage0.yaml", "Scenes", ai_id=1)

    # 上传对应的 affection level
    #upload_yaml("D:\\profiles\\景柚\\affection\\affection_rules.yaml", "Affection_levels", ai_id=2)
